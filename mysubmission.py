...
def deploy(img_path):
    ...
    net = caffe.Classifier('/dli/data/digits/20200513-103004-4fad/deploy.prototxt', '/dli/data/digits/20200513-103004-4fad/snapshot_iter_216.caffemodel',
                           channel_swap=(2,1,0),
                           raw_scale=255,
                           image_dims=(256, 256))
    ...
    mean_image = caffe.io.load_image('/dli/data/digits/20200513-102240-ebce/mean.jpg')
